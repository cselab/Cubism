...
template <typename Real>
inline void pack_stripes1(const Real *const srcbase, Real *const dst, const unsigned int gptfloats, const int selstart, const int selend, const int xstart, const int ystart, const int zstart, const int xend, const int yend, const int zend, const int BSX, const int BSY)
{
   for (int idst = 0, iz = zstart; iz < zend; ++iz)
      for (int iy = ystart; iy < yend; ++iy)
         for (int ix = xstart; ix < xend; ++ix)
         {
            ...
            for (int ic = selstart; ic < selend; ic++, idst++) dst[idst] = src[ic];
         }
}

template <typename Real>
inline void pack_stripes_(const Real *const srcbase, Real *const dst, const unsigned int gptfloats, const int selstart, const int selend, const int xstart, const int ystart, const int zstart, const int xend, const int yend, const int zend, const int BSX, const int BSY)
{
...
template <typename Real>
inline void pack_stripes_x(const Real *const srcbase, Real *const dst, const unsigned int gptfloats, const int selstart, const int selend, const int xstart, const int ystart, const int zstart, const int xend, const int yend, const int zend, const int BSX, const int BSY)
{
   const int seldiff = selend - selstart;
   const int nbytes  = seldiff * sizeof(Real);
   ...
   for (int idst = 0, iz = zstart; iz < zend; ++iz)
   {
      for (int iy = ystart; iy < yend; ++iy)
      {
         ...
         while (repeat-- > 0)
         {
            ...
            memcpy2((char *)&dst[idst + 3 * seldiff], (char *)&src3[selstart], nbytes);
            idst += 4 * seldiff;
            ix += 4;
         }
...
template <typename Real>
inline void pack_stripesxx(const Real *const srcbase, Real *const dst, const unsigned int gptfloats, const int selstart, const int selend, const int xstart, const int ystart, const int zstart, const int xend, const int yend, const int zend, const int BSX, const int BSY)
{
         ...
         /*			else if ((xend - xstart)%8 == 0)
                     {
                         for(int ix=xstart; ix<xend; ix+=8)
                         {
                             ...
                             const Real * src2 = src1 + gptfloats;
                             const Real * src3 = src2 + gptfloats;
                             const Real * src4 = src3 + gptfloats;
                             ...
                             memcpy2((char *)&dst[idst+2*seldiff], (char *)&src2[selstart], nbytes);
                             memcpy2((char *)&dst[idst+3*seldiff], (char *)&src3[selstart], nbytes);
                             memcpy2((char *)&dst[idst+4*seldiff], (char *)&src4[selstart], nbytes);
                             memcpy2((char *)&dst[idst+5*seldiff], (char *)&src5[selstart], nbytes);
                             memcpy2((char *)&dst[idst+6*seldiff], (char *)&src6[selstart], nbytes);
                             memcpy2((char *)&dst[idst+7*seldiff], (char *)&src7[selstart], nbytes);
                             idst += 8*seldiff;
                         }
                     }*/
         else
...
template <typename Real>
inline void pack_stripes(const Real *const srcbase, Real *const dst, const unsigned int gptfloats, const int selstart, const int selend, const int xstart, const int ystart, const int zstart, const int xend, const int yend, const int zend, const int BSX, const int BSY)
{
   const int seldiff = selend - selstart;
   const int nbytes  = seldiff * sizeof(Real);
...
template <typename Real>
inline void unpack(const Real *const pack, Real *const dstbase, const unsigned int gptfloats, const int *const selected_components, const int ncomponents, const int nsrc, const int dstxstart, const int dstystart, const int dstzstart, const int dstxend, const int dstyend, const int dstzend, const int xsize, const int ysize, const int zsize)
{
   for (int s = 0, zd = dstzstart; zd < dstzend; ++zd)
      for (int yd = dstystart; yd < dstyend; ++yd)
         for (int xd = dstxstart; xd < dstxend; ++xd)
         {
            ...
            for (int c = 0; c < ncomponents; ++c, ++s) dst[selected_components[c]] = pack[s];
         }
}

template <typename Real>
inline void unpack1(const Real *const pack, Real *const dstbase, const unsigned int gptfloats, const int *const selected_components, const int ncomponents, const int nsrc, const int dstxstart, const int dstystart, const int dstzstart, const int dstxend, const int dstyend, const int dstzend, const int xsize, const int ysize, const int zsize)
{
   ...
   for (int s = 0, zd = dstzstart; zd < dstzend; ++zd)
      for (int yd = dstystart; yd < dstyend; ++yd)
         for (int xd = dstxstart; xd < dstxend; ++xd)
         {
            ...
            memcpy2((char *)(dst + first_component), (char *)&pack[s], ncomponents * sizeof(Real));
            s += ncomponents;
         }
}

template <typename Real>
inline void unpack2(const Real *const pack, Real *const dstbase, const unsigned int gptfloats, const int *const selected_components, const int ncomponents, const int nsrc, const int dstxstart, const int dstystart, const int dstzstart, const int dstxend, const int dstyend, const int dstzend, const int xsize, const int ysize, const int zsize)
{
   int first_component = selected_components[0];
   ...
   for (int s = 0, zd = dstzstart; zd < dstzend; ++zd)
      for (int yd = dstystart; yd < dstyend; ++yd)
      {
         ...
         else
         {
            ...
            {
               Real *const dst0 = dstbase + gptfloats * (xd + xsize * (yd + ysize * zd)) + first_component;
